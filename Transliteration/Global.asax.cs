...
namespace Transliteration
{
    ...
    {
        static public Oggy.Transliterator.TransliteratorManager transliteratorManager;
        ...
        void Application_Start(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                repository = new Oggy.Repository.SqlRepository();
            }
            ...
            transliteratorManager = new TransliteratorManager();
