<%@ Page Title="Transliterator" Language="C#" Debug="true" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeBehind="Index.aspx.cs" EnableViewStateMac="false"
    Inherits="Transliteration._Default" %>
    ...
    <div class="div-1">
        <div class="div-1a">
            ...
            <table id="table" width="400px">
                ...
                <tr>
                    <td>
                        <asp:TextBox ID="SourceText" runat="server" Width="500" Height="150px" AutoPostBack="True"
                            OnTextChanged="Transliterate" TextMode="MultiLine" />
                    </td>
                    <td>
