...
namespace Oggy.Transliterator
{
    ...
    public class Transliterator : TransliteratorBase
    {
        ...
        public Transliterator(Dictionary<string, string> rules)
        {
            this.rules = rules;
        ...
        public string Transliterate2(string text)
        {
            ...
            {
                string add;
                Rule rule = ruleCollection.FindBestRule(source);
        ...
        /// <summary>
        /// Perform transliteration (without delimeters, for a single word)
        /// </summary>
